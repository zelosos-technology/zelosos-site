    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <div class="px-4 py-4">
                    <form action="{{ route('services.update',$EditingService) }}"method="POST">
                        @csrf
                        @method('Put')
                        <div>
                        ...
                        <div class="py-4">
                            ...
                            <x-input id="title" class="block mt-1 w-full" type="text" name="title"
                                :value="$EditingService->title" required autofocus autocomplete="name"
                        ...
                        <div class="py-4">
                            ...
                            <x-input id="description" class="block mt-1 w-full" type="text" name="description"
                                value="{{ $EditingService->description }}" required autofocus autocomplete="name"
                                placeholder="Insira a descrição do serviço" />
                        </div>

                        <x-button class="mt-4">
                            {{ _('Actulizar as informações') }}
                        </x-button>
